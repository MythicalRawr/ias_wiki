...
---
function ITEM:sendMessage(slot, packet)
end
...
---
function ITEM:onNetRead(packet)
end
...
---
function ITEM:onNetWrite(packet)
end
...
---
function ITEM:onSlotChanged(slot)
end
...
---
function ITEM:destroy(quantity)
end
...
---
function ITEM:canCombine(other)
end
